...
export async function PATCH(request: Request, context: RouteContext) {
    try {
        ...
        const updatePayload: Database["public"]["Tables"]["itinerary_segments"]["Update"] = {
            ...
            location_name: typeof body.location_name === "string" ? body.location_name : undefined,
            ...
            provider_name: typeof body.provider_name === "string" ? body.provider_name : undefined,
            confirmation_code: typeof body.confirmation_code === "string" ? body.confirmation_code : undefined,
            transport_number: typeof body.transport_number === "string" ? body.transport_number : undefined,
            cost_amount: typeof body.cost_amount === "number" ? body.cost_amount : undefined,
            cost_currency: typeof body.cost_currency === "string" ? body.cost_currency : undefined,
        };
